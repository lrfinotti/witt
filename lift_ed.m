...
function lift_ed(a0,n : pols:=[], verb:=true, cstr:=[], check:=true, minimal:=false)
    ...
    for i in [1..n] do
        ...
        // mod out by the curve -- this does the job of reducing
...
function lift_ed_b(a0,b0,n : pols:=[], verb:=true, cstr:=[], check:=true, minimal:=false)
